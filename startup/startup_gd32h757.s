/**
  ******************************************************************************
  * @file      startup_GD32h757xx_CM7.s
  * @brief     GD32H757xx devices vector table for GCC based toolchains.
  *            This startup performs:
  *              - Set the initial SP
  *              - Set the initial PC == Reset_Handler
  *              - Initialize data/bss
  *              - Branch to the C library entry point which later calls main()
  ******************************************************************************
  * Copyright (c) 2024
  * SPDX-License-Identifier: Apache-2.0
  *
  * Derived from the official GD32H7xx Keil startup and the STM32H757xx GCC
  * template to match the toolchain used in this project.
  ******************************************************************************
  */
...
/******************************************************************************
*
* The minimal vector table for a Cortex-M processor. Note that the proper
* constructs must be placed to ensure that it ends up at physical address
* 0x0000.0000.
*
*******************************************************************************/
...
g_pfnVectors:
  ...
  .word  TAMPER_STAMP_LXTAL_IRQHandler            /* 18:RTC Tamper and TimeStamp through EXTI Line detect, LXTAL clock security system interrupt */
